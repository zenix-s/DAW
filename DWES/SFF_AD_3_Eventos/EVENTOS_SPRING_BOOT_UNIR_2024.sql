...
INSERT INTO `EVENTOS` (`NOMBRE`,`DESCRIPCION`,`FECHA_INICIO`,`DURACION`,`DIRECCION`,`ESTADO`,`DESTACADO`,`AFORO_MAXIMO`,`MINIMO_ASISTENCIA`,`PRECIO`,`ID_TIPO`) VALUES ('Curso de Spring Boot','Curso de Spring Boot', '2024-06-01', 3, 'Calle Alcala 20, Madrid', 'ACTIVO', 'S', 5, 10, 100, 2);
INSERT INTO `EVENTOS` (`NOMBRE`,`DESCRIPCION`,`FECHA_INICIO`,`DURACION`,`DIRECCION`,`ESTADO`,`DESTACADO`,`AFORO_MAXIMO`,`MINIMO_ASISTENCIA`,`PRECIO`,`ID_TIPO`) VALUES ('Curso de Angular','Curso de Angular', '2024-06-01', 3, 'Calle Alcala 20, Madrid', 'NOACTIVO', 'S', 15, 10, 100, 2);
...
INSERT INTO `EVENTOS` (`NOMBRE`,`DESCRIPCION`,`FECHA_INICIO`,`DURACION`,`DIRECCION`,`ESTADO`,`DESTACADO`,`AFORO_MAXIMO`,`MINIMO_ASISTENCIA`,`PRECIO`,`ID_TIPO`) VALUES ('Conferencia de Spring Boot','Conferencia de Spring Boot', '2024-06-01', 3, 'Calle Alcala 20, Madrid', 'ACTIVO', 'N', 20, 10, 100, 3);
