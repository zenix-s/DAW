...
INSERT INTO `EVENTOS` (`NOMBRE`,`DESCRIPCION`,`FECHA_INICIO`,`DURACION`,`DIRECCION`,`ESTADO`,`DESTACADO`,`AFORO_MAXIMO`,`MINIMO_ASISTENCIA`,`PRECIO`,`ID_TIPO`) VALUES ('Curso de Spring Boot','Curso de Spring Boot', '2024-06-01', 3, 'Calle Alcala 20, Madrid', 'ACTIVO', 'S', 20, 10, 100, 2);
INSERT INTO `EVENTOS` (`NOMBRE`,`DESCRIPCION`,`FECHA_INICIO`,`DURACION`,`DIRECCION`,`ESTADO`,`DESTACADO`,`AFORO_MAXIMO`,`MINIMO_ASISTENCIA`,`PRECIO`,`ID_TIPO`) VALUES ('Curso de Angular','Curso de Angular', '2024-06-01', 3, 'Calle Alcala 20, Madrid', 'NOACTIVO', 'S', 20, 10, 100, 2);
...
INSERT INTO `EVENTOS` (`NOMBRE`,`DESCRIPCION`,`FECHA_INICIO`,`DURACION`,`DIRECCION`,`ESTADO`,`DESTACADO`,`AFORO_MAXIMO`,`MINIMO_ASISTENCIA`,`PRECIO`,`ID_TIPO`) VALUES ('Webinar de Spring Boot','Webinar de Spring Boot', '2024-06-01', 3, 'Calle Alcala 20, Madrid', 'NOACTIVO', 'S', 20, 10, 100, 1);
...
INSERT INTO `EVENTOS` (`NOMBRE`,`DESCRIPCION`,`FECHA_INICIO`,`DURACION`,`DIRECCION`,`ESTADO`,`DESTACADO`,`AFORO_MAXIMO`,`MINIMO_ASISTENCIA`,`PRECIO`,`ID_TIPO`) VALUES ('Webinar de Angular','Webinar de Angular', '2024-06-01', 3, 'Calle Alcala 20, Madrid', 'ACTIVO', 'S', 20, 10, 100, 1);
INSERT INTO `EVENTOS` (`NOMBRE`,`DESCRIPCION`,`FECHA_INICIO`,`DURACION`,`DIRECCION`,`ESTADO`,`DESTACADO`,`AFORO_MAXIMO`,`MINIMO_ASISTENCIA`,`PRECIO`,`ID_TIPO`) VALUES ('Webinar de Java','Webinar de Java', '2024-06-01', 3, 'Calle Alcala 20, Madrid', 'ACTIVO', 'S', 20, 10, 100, 1);
INSERT INTO `EVENTOS` (`NOMBRE`,`DESCRIPCION`,`FECHA_INICIO`,`DURACION`,`DIRECCION`,`ESTADO`,`DESTACADO`,`AFORO_MAXIMO`,`MINIMO_ASISTENCIA`,`PRECIO`,`ID_TIPO`) VALUES ('Conferencia de Spring Boot','Conferencia de Spring Boot', '2024-06-01', 3, 'Calle Alcala 20, Madrid', 'ACTIVO', 'S', 20, 10, 100, 3);
